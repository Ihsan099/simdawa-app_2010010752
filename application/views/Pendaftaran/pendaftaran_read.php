                ...
                <div class="page-header">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= base_url('home') ?>" class="breadcrumblink">
                                        Dashboard</a></li>
...
?>
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pendaftaran/cetak') ?>" class="btn btn-sm btn-info mr-1 float-right">
...
echo "<td>
<a href=" . base_url('pendaftaran/verifikasi/acc/' . $a->id) . "
class='btn btn-info btn-sm'><i class='fa fa-check'></i> Konfirmasi</a>
<a href=" . base_url('pendaftaran/verifikasi/batal/' . $a->id) . "
class='btn btn-danger btn-sm' onclick='return confirm(\"Ingin batalkan akun ini?\")'><i class='fa fa-ban'></i>
Batalkan</a>
</td>";
else :
